	...
	return (
		<footer className="border-t border-slate-200 dark:border-neutral-800 mt-auto">
			<div className="container mx-auto flex flex-col items-center gap-6 sm:gap-8 py-8 sm:py-12 md:py-16 px-4 sm:px-5">
				{/* Blog Name */}
				<h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-slate-900 dark:text-[hsla(0,0%,100%,.87)]">
					{publication.displayTitle || publication.title}
				</h2>

				{/* Copyright */}
				<div className="text-sm sm:text-base text-slate-600 dark:text-[hsla(0,0%,100%,.6)] text-center">
					...
					<div className="flex items-center justify-center gap-4 sm:gap-6">
						...
						{publication.links.github && (
							<a
								...
								target="_blank"
								rel="noopener noreferrer"
								className="text-slate-600 hover:text-slate-900 dark:text-[hsla(0,0%,100%,.6)] dark:hover:text-[hsla(0,0%,100%,.87)] transition-colors"
								title="GitHub"
								aria-label="GitHub"
							>
				...
				<div className="text-xs sm:text-sm text-slate-500 dark:text-[hsla(0,0%,100%,.6)] text-center pt-2 border-t border-slate-200 dark:border-neutral-800 w-full max-w-md">
